...
function playerCanWin(stoneCount) {
    if (stoneCount <= 1) {
        return false;
    }
    
    if (!playerCanWin(stoneCount - 2)) {
        return true;
    } else if (!playerCanWin(stoneCount - 3)) {
        return true;
    } else if (!playerCanWin(stoneCount - 5)) {
        return true;
    } else {
        return false;
    }
...
console.log(playerCanWin(7))
console.log(playerCanWin(6))